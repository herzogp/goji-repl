...
def exec_main():
    ...
    repl_parser.add_argument('-r', '--show-rules', default=False, action='store_true', help='Show parsing rules')
    repl_parser.add_argument('-t', '--show-tokens', default=False, action='store_true', help='Show tokens')
    repl_parser.add_argument('-p', '--show-parsing', default=False, action='store_true', help='Show parsing')
